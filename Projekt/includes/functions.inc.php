 ...
 */
 ...
 /* 
  *  Schreibt die Navigation der HTML Seite (basierend auf Bootstrap 5,
  *             basierend auf Bootstrap 5, nur eine Ebene
  *  @param $nav array required
            $nav[0] = Branding
            $nav[1] = array() mit Menüpunkten(EIne Ebene)
  * 
  *  @return string Navigationsleiste für dei Webseite 
  */
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
    	    ...
    	    <?php  foreach($nav[1] as $item => $url): ?>
                ...
                <li class="nav-item">
                    <a href="<?php echo $url; ?>" class="nav-link <?php echo $class_active; ?>" <?php echo $current; ?>><?php echo $item; ?></a>
                </li>
...
?>
    ...
    <footer >
    <div class="<?php echo $class_fluid; ?>">
        <p>&copy; <?php echo date('Y'); ?> Huegel William </p>
    </div>
